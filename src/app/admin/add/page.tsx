    ...
    <div className="max-w-3xl mx-auto px-4 pb-10 space-y-8">
      ...
      <section className="bg-surface rounded-xl border p-5">
        ...
        <form action={createTask} className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div className="sm:col-span-2"><label className={labelClass}>Источник</label><input name="source_name" className={inputClass} placeholder="Олимпиада.ру / официальный организатор" /></div>
          <div className="sm:col-span-2"><label className={labelClass}>Прямая ссылка на файл заданий</label><input name="source_url" type="url" className={inputClass} placeholder="https://…pdf" /></div>
          <div className="sm:col-span-2"><label className={labelClass}>Прямая ссылка на ответы / критерии</label><input name="answers_url" type="url" className={inputClass} placeholder="https://…pdf" /></div>
